...
class MovimientoCaja(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    tipo = db.Column(db.String(20), nullable=False)  # entrada, salida o gasto
...
# ======================================================
# 📊 LIQUIDACIÓN (antigua, aún usada para caja)
# ======================================================
...
# ======================================================
# 🧮 LIQUIDACIÓN DE PRODUCTOS (nueva versión)
# ======================================================
...
class HistorialInventario(db.Model):
    ...
    producto_id = db.Column(db.Integer, db.ForeignKey('producto.id'), nullable=False)
    cantidad = db.Column(db.Integer, nullable=False)
    valor_total = db.Column(db.Float, nullable=True)  # opcional
    fecha = db.Column(db.DateTime, default=datetime.now)
